...
loadVideosFrom = "/home/pablo/Documents/Datasets/FaceChannelMultiple/VideosTest/" #Folde where the videos are
...
for videoDirectory in os.listdir(loadVideosFrom): #for each video inside this folder
    ...
    while (cap.isOpened() and not frameCount == total):  # for each frame in this video
        ...
        # detect faces
        facePoints, face = imageProcessing.detectFace(frame, multiple=True)

        print ("Shape faces:" + str(numpy.array(face).shape))
        input("here")
