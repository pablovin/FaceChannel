...
from FaceChannel.SelfAffectiveMemory.SelfAffectiveMemory import SelfAffectiveMemory
from FaceChannel.FaceChannelV1.imageProcessingUtil import imageProcessingUtil
import cv2
from Utils import GUIController
import numpy

selfAffMemory = SelfAffectiveMemory()
...
while(True):
    ...
    # Capture frame-by-frame
        ...
        if not len(face) == 0:
            ...
            dimensionalRecognition = numpy.array(selfAffMemory.predict(face, preprocess=False))
            affectiveMemoryNodes, affectiveMemoryNodesAges = selfAffMemory.getNodes()
            ...
            # print ("Recognition:" +str(dimensionalRecognition))
            arousals.append(dimensionalRecognition[0])
            valences.append(dimensionalRecognition[1])
